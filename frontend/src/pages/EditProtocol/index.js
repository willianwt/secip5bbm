...
export default function Protocol() {
  ...
  const [tipo, setTipo] = useState(location.state.protocol.type);
  const [bairro, setBairro] = useState(location.state.protocol.district);
  const [situacao, setSituacao] = useState(location.state.protocol.situation);
  const [data, setData] = useState(location.state.protocol.date);
  const [vistoria, setVistoria] = useState(location.state.protocol.inspection);
  const [divisao, setDivisao] = useState(location.state.protocol.division);
  const [observacoes, setObservacoes] = useState(location.state.protocol.observations);
  ...
  return (
    <div className="container">
      ...
      <form onSubmit={handleEditProtocol} autoComplete="off">
        <div className="form-row">
          ...
          <div className="col-md-3 mb-3">
            ...
            <select className="custom-select" id="tipo" defaultValue={tipo} name="tipo" onChange={(e) => setTipo(e.target.value)} required>
          ...
          <div className="col-md-3 mb-3">
            ...
            <div className="input-group">
              <select className="custom-select" id="bairro" defaultValue={bairro} name="bairro" onChange={(e) => setBairro(e.target.value)} required>
        ...
        <div className="form-row">
          <div className="col-md-3 mb-3">
            ...
            <select className="custom-select" id="situacao" defaultValue={situacao} name="situacao" onChange={(e) => setSituacao(e.target.value)} required>
          ...
          <div className="col-md-3 mb-3">
            ...
            <select className="custom-select" id="vistoria" defaultValue={vistoria} name="vistoria" onChange={(e) => setVistoria(e.target.value)} required>
          ...
          <div className="col-md-3 mb-3">
            ...
            <select className="form-control" name="divisao" id="divisao" defaultValue={divisao} onChange={(e) => setDivisao(e.target.value)} required>
        ...
        <div className="px-0 form-inline">
          <div className="offset-md-3 col-md-3 px-0 form-inline">
            ...
            <select className="form-control mx-2 mb-2" id="mei" name="mei" defaultValue={mei === 'sim' ? 'sim' : 'nao'} onChange={(e) => { setMei(e.target.value); }}>
